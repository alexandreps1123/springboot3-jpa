...
import com.parkus.springboot3jpa.entities.Payment;
...
import com.parkus.springboot3jpa.repositories.OrderItemRepository;
import com.parkus.springboot3jpa.repositories.OrderRepository;
import com.parkus.springboot3jpa.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Payment pay1 = new Payment(null, Instant.parse("2023-01-12T21:53:07Z"), o1);
		o1.setPayment(pay1);
